...
abstract public class Robot {
	...
	public void subitMine() throws UnsupportedAudioFileException, IOException, LineUnavailableException{
		File explo = new File("music/bombe.wav");
		AudioInputStream bruit = AudioSystem.getAudioInputStream(explo);
		Clip explosion = AudioSystem.getClip();
		explosion.open(bruit);
		explosion.start();
