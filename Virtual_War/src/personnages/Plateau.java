...
public class Plateau extends JPanel{
	...
	public Plateau(int larg, int haut, int obst) {
		...
		plateau.setLocation(300, 50);
		plateau.setLayout(new FlowLayout());
		plateau.setDefaultCloseOperation(3);

		setPreferredSize(new Dimension(Plateau.grille.length * dimImage + 20, Plateau.grille[0].length * dimImage + 20));
<<<<<<< HEAD
...
>>>>>>> 01e94f70828b0814cc4ad87c39ee15c5da184990
			...
			for(int j=0;j<Plateau.grille[0].length;j++){
				if(i == Plateau.grille.length -1){
<<<<<<< HEAD
					g.setColor(Color.BLACK);
				g.drawString(j + "", x+20, y+65);
				g.setColor(Color.WHITE);
=======
				g.drawString(j + "", x+20, y+65);
>>>>>>> 01e94f70828b0814cc4ad87c39ee15c5da184990
