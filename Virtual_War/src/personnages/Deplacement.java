...
public class Deplacement extends Action {
	...
	public void agit() throws UnsupportedAudioFileException, IOException, LineUnavailableException {
...
// 		Plateau.grille[0].length <-- y
		...
		// ALLER SUR LES BORDS
		// En haut
		if(objectif.getCoordCell().getPositionY() == 0 && 0 < objectif.getCoordCell().getPositionX()
				&& objectif.getCoordCell().ajouterCoord(Constantes.bas).equals(super.getRobot().getCoordonnee())){
			return true;
		// En bas
		}else if(objectif.getCoordCell().getPositionY() == Plateau.grille[0].length-1 && objectif.getCoordCell().getPositionX() < Plateau.grille.length-1
				&& objectif.getCoordCell().ajouterCoord(Constantes.haut).equals(super.getRobot().getCoordonnee())){
			return true;
		// A gauche
		}else if(objectif.getCoordCell().getPositionX() == 0 && 0 < objectif.getCoordCell().getPositionY()
				&& objectif.getCoordCell().ajouterCoord(Constantes.droite).equals(super.getRobot().getCoordonnee())){
			return true;
		// A droite
		}else if(objectif.getCoordCell().getPositionX() == Plateau.grille.length-1 && objectif.getCoordCell().getPositionY() < Plateau.grille[0].length-1
				&& objectif.getCoordCell().ajouterCoord(Constantes.gauche).equals(super.getRobot().getCoordonnee())){
			return true;
		}
