...
@WebServlet("/addfilmPreferenceUser")
public class AddFilmPreferenceUser extends HttpServlet{
  ...
  public void doGet( HttpServletRequest req, HttpServletResponse res )throws  IOException{
    ...
    try{
      ...
      st.executeUpdate("insert into preferences_film (idfilm,iduser) values("+Integer.parseInt(idfilm)+","+Integer.parseInt(iduser)+")");
