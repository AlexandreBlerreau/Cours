...
@WebServlet("/deleteDetailFilm")
public class DetailFilmDelete extends HttpServlet{
	...
	public void doGet( HttpServletRequest req, HttpServletResponse res )throws  IOException{
		...
		try{
			...
			out.println("<form method='get' action='http://localhost:8080/vide/deletefilmPreferenceUser'>");
			out.println("<tr><td><input type='submit' style='height:30px; background-color: #87CEEB; border: none;font-size: 15px' value='Supprimer de mes préférences'</td></tr>");
			out.println("</form>");
	...
	public String traiterDate(String date){
