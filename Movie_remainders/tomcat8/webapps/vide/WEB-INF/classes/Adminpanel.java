	...
	throws  IOException
	{
		...
		try{
			...
			// session valide
				...
				// tableau bouton gestion des utilisateurs
				
				out.println("<table style='text-align=center;'>");
				out.println("<form method='post' action='http://localhost:8080/vide/manageuser'>");
				out.println("<tr><td><input type='submit' style='height:40px; background-color: #87CEEB; border: none;font-size: 20px' value='Gérer les utilisateurs'</td></tr>");
				out.println("</form>");
				out.println("</table>");
